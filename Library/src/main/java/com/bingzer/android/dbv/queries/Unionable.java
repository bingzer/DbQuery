...
public interface Unionable {
     ...
     * @param select {@link IQuery.Select} object
     * @return {@link IQuery.Union} object
     */
    IQuery.Union union(IQuery.Select select);
     ...
     * @return {@link IQuery.Union} object
     */
    IQuery.Union unionAll(IQuery.Select select);
}
