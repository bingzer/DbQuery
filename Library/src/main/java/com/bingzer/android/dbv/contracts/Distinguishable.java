...
public interface Distinguishable {
     ...
     * @return {@link com.bingzer.android.dbv.queries.Select}
     */
    Select selectDistinct(String condition);
     ...
     * @return {@link com.bingzer.android.dbv.queries.Select}
     */
    Select selectDistinct(String whereClause, Object... args);
     ...
     * @return {@link com.bingzer.android.dbv.queries.Select}
     */
    Select selectDistinct(int top, String condition);
     ...
     * @return {@link com.bingzer.android.dbv.queries.Select}
     */
    Select selectDistinct(int top, String whereClause, Object... args);
}
