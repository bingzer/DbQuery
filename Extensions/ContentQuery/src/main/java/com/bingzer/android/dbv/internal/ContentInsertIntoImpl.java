 ...
 */
class ContentInsertIntoImpl extends QueryImpl<Long> implements InsertInto {

    private Uri value;
    private ContentSet query;
    private String[] columnNames;

    public ContentInsertIntoImpl(ContentSet query, String... columnNames){
        this.query = query;
    ...
    public static interface ContentSet {
        ...
        void onContentValuesSet(ContentInsertIntoImpl query, ContentValues contentValues);
